...
var fixtures = []fixture{
	{
		name: "stimustop-api", project: "StimuStop", env: "production", server: "hetzner-fsn1",
		branch: "main", status: "running:healthy", domains: []string{"api.stimustop.com"},
		repo: "git@github.com:resetnak/stimustop-api.git", pack: "nixpacks",
		lastDeploy: 3 * time.Minute, deployStatus: domain.DeploymentFinished,
		description: "Public REST API",
	},
	{
		name: "stimustop-web", project: "StimuStop", env: "production", server: "hetzner-fsn1",
		branch: "main", status: "running:healthy", domains: []string{"stimustop.com", "www.stimustop.com"},
		repo: "git@github.com:resetnak/stimustop-web.git", pack: "static",
		lastDeploy: 3 * time.Minute, deployStatus: domain.DeploymentFinished,
	},
	{
		name: "resetnak-web", project: "Personal", env: "production", server: "hetzner-fsn1",
		branch: "main", status: "in_progress", domains: []string{"resetnak.cz"},
		repo: "git@github.com:resetnak/resetnak-cz.git", pack: "static",
		lastDeploy: 21 * time.Second, deployStatus: domain.DeploymentInProgress,
		description: "Personal site",
	},
	{
		name: "maintenea-worker", project: "Maintenea", env: "production", server: "hetzner-nbg1",
		branch: "main", status: "exited:unhealthy",
		repo: "git@github.com:resetnak/maintenea.git", pack: "dockerfile",
		lastDeploy: 2 * time.Hour, deployStatus: domain.DeploymentFailed,
		description: "Background job runner",
	},
	{
		name: "maintenea-api", project: "Maintenea", env: "production", server: "hetzner-nbg1",
		branch: "main", status: "running:unhealthy", domains: []string{"api.maintenea.dev"},
		repo: "git@github.com:resetnak/maintenea.git", pack: "nixpacks",
	...
	{
		name: "weektraq-api", project: "Weektraq", env: "staging", server: "hetzner-nbg1",
		branch: "develop", status: "running:healthy", domains: []string{"staging-api.weektraq.app"},
		repo: "git@github.com:resetnak/weektraq.git", pack: "dockercompose",
		lastDeploy: 26 * time.Hour, deployStatus: domain.DeploymentFinished,
	},
	{
		name: "weektraq-web", project: "Weektraq", env: "staging", server: "hetzner-nbg1",
		branch: "develop", status: "exited", domains: []string{"staging.weektraq.app"},
		repo: "git@github.com:resetnak/weektraq.git", pack: "nixpacks",
		lastDeploy: 26 * time.Hour, deployStatus: domain.DeploymentFinished,
		description: "Stopped to save resources",
	},
	{
		name: "logen-ingest-service-with-a-very-long-name", project: "Logen", env: "production",
		server: "contabo-eu", branch: "main", status: "running:healthy",
		domains: []string{"ingest.logen.example-with-a-rather-long-domain-name.com"},
		repo:    "git@github.com:resetnak/logen.git", pack: "dockerfile",
		lastDeploy: 5 * 24 * time.Hour, deployStatus: domain.DeploymentFinished,
		description: "Exercises column truncation",
	},
	{
		name: "logen-dashboard", project: "Logen", env: "preview", server: "contabo-eu",
		branch: "feat/charts", status: "restarting:starting",
		repo: "git@github.com:resetnak/logen.git", pack: "railpack",
		lastDeploy: 90 * time.Second, deployStatus: domain.DeploymentFinished,
	},
	{
		name: "mpd-api", project: "MPD", env: "development", server: "local-dev",
		branch: "main", status: "", // an unknown status must render safely
		repo: "git@github.com:resetnak/mpd.git", pack: "dockercompose",
		deployStatus: domain.DeploymentUnknown,
	},
	{
		name: "nosmoko", project: "Personal", env: "production", server: "hetzner-fsn1",
		branch: "main", status: "running:healthy", domains: []string{"nosmoko.app"},
		repo: "git@github.com:resetnak/nosmoko.git", pack: "nixpacks",
		lastDeploy: 11 * 24 * time.Hour, deployStatus: domain.DeploymentFinished,
	},
	{
		name: "shredloq", project: "Personal", env: "production", server: "hetzner-fsn1",
		branch: "main", status: "queued", domains: []string{"shredloq.com"},
		repo: "git@github.com:resetnak/shredloq.git", pack: "nixpacks",
